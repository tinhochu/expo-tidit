import JustListedTemplate from '@/components/JustListedTemplate'
  ...
  return (
    ...
    >
      <VStack className="min-h-screen">
        ...
        <ScrollView>
          {data?.propInformation.photos.length > 0 && <PropertyImage imageUrl={data?.propInformation.photos[0].href} />}
        </ScrollView>
      </VStack>
    </KeyboardAvoidingView>
  )
